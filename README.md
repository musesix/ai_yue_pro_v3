...
## ✨ 优化-ai_yue_pro_v3.py
复刻自 https://github.com/JohnLone00/AiYue 并在此做了些优化 致谢原作者

使用技巧：域名白名单处添加需要测试的域名

✨ 优化了展示界面，以及增加了排序以及复制多个url链接功能，默认过滤一些静态资源

![image-20260128111637687](image/image-20260128111637687.png)
